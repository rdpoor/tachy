...
#define CONF_SLCD_CONTRAST_ADJUST 8
#endif
...
#define CONF_SLCD_CM_7SEGS_1_SETTING 2
#endif
// <o> Segment 2 Setting
//   <i> Segment index for the character mapping area
//   <i> Index 0 is the Character mapping beinging COMn/SEGn, Index 1 is COMn/SEGn + 1
...
#define CONF_SLCD_CM_7SEGS_2_SETTING 5
#endif
// <o> Segment 3 Setting
//   <i> Segment index for the character mapping area
//   <i> Index 0 is the Character mapping beinging COMn/SEGn, Index 1 is COMn/SEGn + 1
...
#define CONF_SLCD_CM_7SEGS_3_SETTING 6
#endif
// <o> Segment 4 Setting
//   <i> Segment index for the character mapping area
//   <i> Index 0 is the Character mapping beinging COMn/SEGn, Index 1 is COMn/SEGn + 1
...
#define CONF_SLCD_CM_7SEGS_5_SETTING 1
#endif
// <o> Segment 6 Setting
//   <i> Segment index for the character mapping area
//   <i> Index 0 is the Character mapping beinging COMn/SEGn, Index 1 is COMn/SEGn + 1
...
#define CONF_SLCD_CM_7SEGS_6_SETTING 3
#endif
...
#define CONF_SLCD_CM_14SEGS_0_SETTING 13
#endif
...
#define CONF_SLCD_CM_14SEGS_1_SETTING 11
#endif
...
#define CONF_SLCD_CM_14SEGS_2_SETTING 1
#endif
...
#define CONF_SLCD_CM_14SEGS_3_SETTING 0
#endif
...
#define CONF_SLCD_CM_14SEGS_4_SETTING 2
#endif
...
#define CONF_SLCD_CM_14SEGS_5_SETTING 12
#endif
...
#define CONF_SLCD_CM_14SEGS_6_SETTING 10
#endif
...
#define CONF_SLCD_CM_14SEGS_7_SETTING 8
#endif
...
#define CONF_SLCD_CM_14SEGS_8_SETTING 9
#endif
...
#define CONF_SLCD_CM_14SEGS_9_SETTING 6
#endif
...
#define CONF_SLCD_CM_14SEGS_10_SETTING 7
#endif
...
#define CONF_SLCD_CM_14SEGS_11_SETTING 4
#endif
...
#define CONF_SLCD_CM_14SEGS_12_SETTING 5
#endif
...
#define CONF_SLCD_CM_14SEGS_13_SETTING 3
#endif
...
#define CONF_SLCD_CHAR1_SEG_IDX 4
#endif
...
#define CONF_SLCD_CHAR2_SEG_IDX 5
#endif
...
#define CONF_SLCD_CHAR3_SEG_IDX 6
#endif
...
#define CONF_SLCD_CHAR4_SEG_IDX 7
#endif
...
#define CONF_SLCD_CHAR5_COM_IDX 1
#endif
...
#define CONF_SLCD_CHAR5_SEG_IDX 8
#endif
...
#define CONF_SLCD_CHAR5_SEG_NUM 2
#endif
...
#define CONF_SLCD_CHAR5_MAPPING_SIZE 14
#endif
...
#define CONF_SLCD_CHAR6_COM_IDX 1
#endif
...
#define CONF_SLCD_CHAR6_SEG_IDX 10
#endif
...
#define CONF_SLCD_CHAR6_SEG_NUM 2
#endif
...
#define CONF_SLCD_CHAR6_MAPPING_SIZE 14
#endif
...
#define CONF_SLCD_CHAR7_COM_IDX 1
#endif
...
#define CONF_SLCD_CHAR7_SEG_IDX 12
#endif
...
#define CONF_SLCD_CHAR7_SEG_NUM 2
#endif
...
#define CONF_SLCD_CHAR7_MAPPING_SIZE 14
#endif
...
#define CONF_SLCD_CHAR8_COM_IDX 1
#endif
...
#define CONF_SLCD_CHAR8_SEG_IDX 14
#endif
...
#define CONF_SLCD_CHAR8_SEG_NUM 2
#endif
...
#define CONF_SLCD_CHAR8_MAPPING_SIZE 14
#endif
...
#define CONF_SLCD_CHAR9_COM_IDX 1
#endif
...
#define CONF_SLCD_CHAR9_SEG_IDX 16
#endif
...
#define CONF_SLCD_CHAR9_SEG_NUM 2
#endif
...
#define CONF_SLCD_CHAR9_MAPPING_SIZE 14
#endif
...
#define CONF_SLCD_CHAR10_COM_IDX 1
#endif
...
#define CONF_SLCD_CHAR10_SEG_IDX 18
#endif
...
#define CONF_SLCD_CHAR10_SEG_NUM 2
#endif
...
#define CONF_SLCD_CHAR10_MAPPING_SIZE 14
#endif
...
#define CONF_SLCD_CHAR11_COM_IDX 1
#endif
...
#define CONF_SLCD_CHAR11_SEG_IDX 20
#endif
...
#define CONF_SLCD_CHAR11_SEG_NUM 2
#endif
...
#define CONF_SLCD_CHAR11_MAPPING_SIZE 14
#endif
...
#define CONF_SLCD_CHAR12_COM_IDX 1
#endif
...
#define CONF_SLCD_CHAR12_SEG_IDX 22
#endif
...
#define CONF_SLCD_CHAR12_SEG_NUM 2
#endif
...
#define CONF_SLCD_CHAR12_MAPPING_SIZE 14
#endif
...
#define CONF_SLCD_LPENL                                                                                                \
	((uint32_t)1 << 6 | (uint32_t)1 << 7 | (uint32_t)1 << 8 | (uint32_t)1 << 9 | (uint32_t)1 << 10 | (uint32_t)1 << 11 \
	 | (uint32_t)1 << 12 | (uint32_t)1 << 13 | (uint32_t)1 << 14 | (uint32_t)1 << 15 | (uint32_t)1 << 16               \
	 | (uint32_t)1 << 17 | (uint32_t)1 << 18 | (uint32_t)1 << 19 | (uint32_t)1 << 20 | (uint32_t)1 << 21               \
	 | (uint32_t)1 << 22 | (uint32_t)1 << 23 | (uint32_t)1 << 24 | (uint32_t)1 << 25 | (uint32_t)1 << 26               \
	 | (uint32_t)1 << 27 | (uint32_t)1 << 30 | (uint32_t)1 << 31 | 0)

#define CONF_SLCD_LPENH                                                                                                \
	((uint32_t)1 << 4 | (uint32_t)1 << 5 | (uint32_t)1 << 6 | (uint32_t)1 << 7 | (uint32_t)1 << 8 | (uint32_t)1 << 9   \
	 | (uint32_t)1 << 10 | (uint32_t)1 << 11 | 0) // </e>
